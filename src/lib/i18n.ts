...
const dict: Record<Lang, Record<string, string>> = {
	en: {
		...
		'preset.newsJunkie.desc': 'Stay on top of breaking news across politics, tech, and finance',
		'preset.trader.name': 'Trader',
		'preset.trader.desc': 'Market-focused dashboard with stocks, crypto, and commodities',
		'preset.geopolitics.name': 'Geopolitics Watcher',
		'preset.geopolitics.desc': 'Global situation awareness and regional hotspots',
		'preset.intel.name': 'Intelligence Analyst',
		'preset.intel.desc': 'Deep analysis, pattern detection, and narrative tracking',
		'preset.minimal.name': 'Minimal',
		'preset.minimal.desc': 'Just the essentials - map, news, and markets',
		'preset.everything.name': 'Everything',
		'preset.everything.desc': 'Kitchen sink - all panels enabled',

		'panelConfig.map': 'Global Map',
		'panelConfig.politics': 'World / Geopolitical',
		'panelConfig.tech': 'Technology / AI',
		'panelConfig.finance': 'Financial',
		'panelConfig.gov': 'Government / Policy',
		'panelConfig.heatmap': 'Sector Heatmap',
		'panelConfig.markets': 'Markets',
		'panelConfig.monitors': 'My Monitors',
		'panelConfig.commodities': 'Commodities / VIX',
		'panelConfig.crypto': 'Crypto',
		'panelConfig.polymarket': 'Polymarket',
		'panelConfig.whales': 'Whale Watch',
		'panelConfig.mainchar': 'Main Character',
		'panelConfig.printer': 'Money Printer',
		'panelConfig.contracts': 'Gov Contracts',
		'panelConfig.ai': 'AI Arms Race',
		'panelConfig.layoffs': 'Layoffs Tracker',
		'panelConfig.venezuela': 'Venezuela Situation',
		'panelConfig.greenland': 'Greenland Situation',
		'panelConfig.iran': 'Iran Situation',
		'panelConfig.leaders': 'World Leaders',
		'panelConfig.intel': 'Intel Feed',
		'panelConfig.correlation': 'Correlation Engine',
		'panelConfig.narrative': 'Narrative Tracker',
		'panelConfig.fed': 'Federal Reserve',
	...
	zh: {
		...
		'preset.newsJunkie.name': '新闻雷达',
		'preset.newsJunkie.desc': '聚焦突发新闻：政治、科技与金融',
		'preset.trader.name': '交易员',
		'preset.trader.desc': '以市场为核心：股票、加密与大宗商品',
		'preset.geopolitics.name': '地缘观察者',
		'preset.geopolitics.desc': '全球态势感知与区域热点追踪',
		'preset.intel.name': '情报分析师',
		'preset.intel.desc': '深度分析、模式识别与叙事追踪',
		'preset.minimal.name': '极简',
		'preset.minimal.desc': '只保留核心：地图、新闻与市场',
		'preset.everything.name': '全量',
		'preset.everything.desc': '全都要：启用所有面板',

		'panelConfig.map': '全球地图',
		'panelConfig.politics': '世界 / 地缘政治',
		'panelConfig.tech': '科技 / AI',
		'panelConfig.finance': '金融',
		'panelConfig.gov': '政府 / 政策',
		'panelConfig.heatmap': '板块热力图',
		'panelConfig.markets': '市场',
		'panelConfig.monitors': '我的监控',
		'panelConfig.commodities': '大宗商品 / VIX',
		'panelConfig.crypto': '加密',
		'panelConfig.polymarket': 'Polymarket',
		'panelConfig.whales': '鲸鱼监控',
		'panelConfig.mainchar': '主角分析',
		'panelConfig.printer': '印钞机',
		'panelConfig.contracts': '政府合同',
		'panelConfig.ai': 'AI 军备竞赛',
		'panelConfig.layoffs': '裁员追踪',
		'panelConfig.venezuela': '委内瑞拉态势',
		'panelConfig.greenland': '格陵兰态势',
		'panelConfig.iran': '伊朗态势',
		'panelConfig.leaders': '世界领导人',
		'panelConfig.intel': '情报流',
		'panelConfig.correlation': '关联引擎',
		'panelConfig.narrative': '叙事追踪',
		'panelConfig.fed': '美联储',
